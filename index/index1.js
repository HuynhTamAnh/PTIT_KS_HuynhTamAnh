...
document.addEventListener("DOMContentLoaded",function(){
    var projectTable= document.getElementById("projecTable");
    ...
    function displayProjects(){
        ...
        projects.forEach(p=>{
            ...
            row.insertCell(1).innerHTML=p.ingUrl;
    ...
    function updateProject(id){
        ...
        if(projectToUpdate){
            ...
            projectToUpdate.link=prompt("Enter new image link")
            projectToUpdate.tags=prompt("Enter new image tags").split(", ")
